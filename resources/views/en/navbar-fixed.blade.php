<section id="navbar" class="navbar-scroll">
    <nav>
        ...
        <img class="sub-menu-logo" id="sub-menu-logo" src="/svg/burger-black.svg" onclick="toggleSubMenu(true)"/> <!-- appears after 1000px -->
        <div class="nav-links" style="color: black;" id="nav-links">
            ...
            <div id="lang" onclick="toggleLanguage()" style="color:black;">EN</div>
        </div>
        <div id="submenu" class="sub-menu">
            ...
            <div id="submenu-lang" onclick="toggleLanguage()">EN</div>
        </div>
    </nav>
</section>